...
$path = "../image/Produk/". $produk["image"];
?>

<div class="container" onload="loadURLToInputFiled('../image/Produk/')">
  ...
  <form action="proses/edit_produk.php" method="post" enctype="multipart/form-data">
    <div class="form-group">
      ...
      <input type="file" id="image" name="image[]" value="<?= $path ?>" onchange="readURL(this);">
      <img id="foto" src="#" />
    ...
    <div class="row">
      <div class="col-md-6">
        <div class="form-group">
          ...
          <input type="text" id="nama" name="nama" placeholder="Masukkan Nama Produk" class="form-control" value="<?= $produk['nama'] ?>">
      ...
      <div class="col-md-6">
        <div class="form-group">
          ...
          <input type="number" class="form-control" id="harga" placeholder="Masukkan Harga Produk" name="harga" value="<?= $produk['harga'] ?>">
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-md-6">
        <button type="submit" class="btn btn-success btn-block"><i class="glyphicon glyphicon-edit"></i> Ubah</button>
      </div>
      <div class="col-md-6">
