		...
		<div class="row top">
			<center>
				<div class="col-md-4" style="padding: 3px;">
					<span> <i class="glyphicon glyphicon-earphone"></i> +62878123456789</span>
				</div>


				<div class="col-md-4"  style="padding: 3px;">
					<span><i class="glyphicon glyphicon-envelope"></i> sepatu-keren@gmail.com</span>
				</div>


				<div class="col-md-4"  style="padding: 3px;">
					<span>Toko Sepatu Keren</span>
				</div>
			</center>
		</div>
	</div>
	...
	<nav class="navbar navbar-default" style="padding: 5px;">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#" style="color: #ff8680"><b>Toko Sepatu Keren</b></a>
			</div>
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav navbar-right">
					...
					$kode_cs = $_SESSION['id_customer'];
					$cek = mysqli_query($conn, "SELECT id from cart where id_customer = '$kode_cs' ");
